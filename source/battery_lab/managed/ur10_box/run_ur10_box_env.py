...
parser = argparse.ArgumentParser(description="Run the UR10 + box manager-based environment.")
...
from my_ur10_box_env_cfg import MyUR10BoxEnvCfg


def main():
    """Main function."""
    # create environment configuration
    env_cfg = MyUR10BoxEnvCfg()
