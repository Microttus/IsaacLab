...
@configclass
class UR10CabinetEnvCfg(DirectRLEnvCfg):
    # env
...
class UR10CabinetEnv(DirectRLEnv):
    ...
    cfg: UR10CabinetEnvCfg

    def __init__(self, cfg: UR10CabinetEnvCfg, render_mode: str | None = None, **kwargs):
